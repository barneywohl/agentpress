...
def main() -> int:
    ...
    payload = {
        ...
        "primary_entrypoints": [
            ...
            "agentpress/use-cases/api-docs.md",
            "agentpress/use-cases/incident-runbooks.md",
            "agentpress/use-cases/dataset-cards.md",
            "agentpress/use-cases/knowledge-bases.md",
            "agentpress/use-cases/agent-frameworks.md",
