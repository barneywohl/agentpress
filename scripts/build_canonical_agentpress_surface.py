...
def main() -> int:
    ...
    payload = {
        ...
        "purpose": "Clean public inventory for agents, crawlers, RAG systems, eval harnesses, MCP-style agents, and coding agents. Legacy stress-test archives are intentionally excluded from primary discovery.",
