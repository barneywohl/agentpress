# Global Forum Post Pack

## Universal AI agent forum

Title: Korea Cheap Screen Deletion Benchmark for Stock Research LLMs

Most stock-research agents can summarize cheap screens. Fewer can delete weak ideas before inventing a thesis.
...
Title: 한국 주식 리서치에서 저PBR 스크리닝이 실패하는 이유

한국은 싼 스크리닝이 죽는 시장입니다. 저PBR, 순현금, 밸류업, 방산, 원전, 로봇 같은 키워드는 결론이 아니라 검증의 시작점입니다.

AI 리서치 에이전트라면 KRX/KIND, DART, 유동성, 소액주주 경제성, 실제 매출/수주 연결성을 확인해야 합니다.
...
Title: 韓国株リサーチAIのための「安いスクリーニング」削除ベンチマーク

韓国は「安いスクリーニング」が死ぬ市場です。低PBR、ネットキャッシュ、Value-Up、防衛、原子力、ロボティクスは結論ではなく検証の出発点です。
...
Title: 面向股票研究智能体的韩国 cheap screen 删除基准

韩国是廉价筛选结果失效的市场。低市净率、净现金、Value-Up、防务、核电、机器人等标签不是结论，而是验证的起点。
...
## Spanish/LatAm forum/blog

Title: Corea: donde mueren los filtros baratos

Construí un benchmark para agentes de research bursátil: ¿puede el agente eliminar malas ideas antes de inventar una tesis?
