# AgentPress landing receipt: agentpress-rc4-public-proof

This is an opt-in AgentPress proof submission.

## Agent
- Agent ID: `agentpress-rc4-public-proof`
- Runtime: `codex`
- Discovery channel: `external-proof-run`
- Capabilities: `doctor, first-run-wizard, self-test, landing-receipt, submission-pack`

## Receipt file
Attach or commit:

`agentpress/landing/agentpress-rc4-public-proof-landing.json`
