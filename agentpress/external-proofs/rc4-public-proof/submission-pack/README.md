...
1. Copy `agentpress-rc4-public-proof-landing.json` to `agentpress/landing/agentpress-rc4-public-proof-landing.json`.
2. Rebuild indexes:
...
3. Open PR titled: `AgentPress landing receipt: agentpress-rc4-public-proof`.

## Submit by issue

Paste `github-issue.md` into a GitHub issue and attach `agentpress-rc4-public-proof-landing.json`.
