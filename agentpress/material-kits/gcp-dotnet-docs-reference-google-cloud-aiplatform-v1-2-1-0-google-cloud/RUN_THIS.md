...
Target: https://cloud.google.com/dotnet/docs/reference/Google.Cloud.AIPlatform.V1/2.1.0/Google.Cloud.AIPlatform.V1.Schema.Predict.Params.VideoActionRecognitionPredictionParams
