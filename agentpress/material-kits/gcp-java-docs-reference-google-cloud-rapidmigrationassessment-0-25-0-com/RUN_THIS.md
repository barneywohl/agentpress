...
Target: https://cloud.google.com/java/docs/reference/google-cloud-rapidmigrationassessment/0.25.0/com.google.cloud.rapidmigrationassessment.v1.Collector.Builder
