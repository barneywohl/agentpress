...
Target: https://cloud.google.com/java/docs/reference/google-cloud-os-config/2.5.6/com.google.cloud.osconfig.v1alpha.Inventory.WindowsQuickFixEngineeringPackage.Builder
