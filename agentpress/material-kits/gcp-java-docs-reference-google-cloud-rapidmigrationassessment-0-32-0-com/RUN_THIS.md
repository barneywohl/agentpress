...
Target: https://cloud.google.com/java/docs/reference/google-cloud-rapidmigrationassessment/0.32.0/com.google.cloud.rapidmigrationassessment.v1.ResumeCollectorRequestOrBuilder
