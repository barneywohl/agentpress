...
Target: https://cloud.google.com/java/docs/reference/google-cloud-os-config/2.50.0/com.google.cloud.osconfig.v1alpha.OSPolicyAssignment.InstanceFilter.Builder
