...
3. Extract source facts from `https://vercel.com/docs/rest-api/edge-config/update-edge-config-items-in-batch`.
4. Run `python3 scripts/agentpress.py material-kit-validate agentpress/material-kits/vercel-edge-config-batch-update --json`.
