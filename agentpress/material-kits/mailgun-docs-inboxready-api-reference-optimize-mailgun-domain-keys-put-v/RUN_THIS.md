...
Target: https://documentation.mailgun.com/docs/inboxready/api-reference/optimize/mailgun/domain-keys/put-v4-domains--authority-name--keys--selector--deactivate
