...
3. Extract source facts from `https://bun.com/reference/node/crypto/DecipherOCB/setAuthTag`.
4. Run `python3 scripts/agentpress.py material-kit-validate agentpress/material-kits/bun-setauthtag --json`.
