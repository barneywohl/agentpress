...
Target: https://cloud.google.com/java/docs/reference/google-cloud-licensemanager/latest/com.google.cloud.licensemanager.v1.QueryConfigurationLicenseUsageResponse.Builder
