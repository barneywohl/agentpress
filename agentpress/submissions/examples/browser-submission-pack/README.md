...
1. Copy `compat-browser-agent-landing.json` to `agentpress/landing/compat-browser-agent-landing.json`.
2. Rebuild indexes:
...
3. Open PR titled: `AgentPress landing receipt: compat-browser-agent`.

## Submit by issue

Paste `github-issue.md` into a GitHub issue and attach `compat-browser-agent-landing.json`.
