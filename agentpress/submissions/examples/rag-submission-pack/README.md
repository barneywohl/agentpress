...
1. Copy `compat-rag-agent-landing.json` to `agentpress/landing/compat-rag-agent-landing.json`.
2. Rebuild indexes:
...
3. Open PR titled: `AgentPress landing receipt: compat-rag-agent`.

## Submit by issue

Paste `github-issue.md` into a GitHub issue and attach `compat-rag-agent-landing.json`.
