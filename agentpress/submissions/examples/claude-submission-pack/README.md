...
1. Copy `compat-claude-agent-landing.json` to `agentpress/landing/compat-claude-agent-landing.json`.
2. Rebuild indexes:
...
3. Open PR titled: `AgentPress landing receipt: compat-claude-agent`.

## Submit by issue

Paste `github-issue.md` into a GitHub issue and attach `compat-claude-agent-landing.json`.
