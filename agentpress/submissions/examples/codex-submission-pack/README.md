...
1. Copy `compat-codex-agent-landing.json` to `agentpress/landing/compat-codex-agent-landing.json`.
2. Rebuild indexes:
...
3. Open PR titled: `AgentPress landing receipt: compat-codex-agent`.

## Submit by issue

Paste `github-issue.md` into a GitHub issue and attach `compat-codex-agent-landing.json`.
