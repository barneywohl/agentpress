# AgentPress Quickstart for codex
...
3. Generate/verify a bundle:
   `python3 scripts/agentpress.py bundle tests/fixtures/source-docs --out /tmp/codex-bundle --title "codex Test Bundle" --force`
   `python3 scripts/agentpress.py verify /tmp/codex-bundle --json`
