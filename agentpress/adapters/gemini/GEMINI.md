# AgentPress Quickstart for gemini
...
3. Generate/verify a bundle:
   `python3 scripts/agentpress.py bundle tests/fixtures/source-docs --out /tmp/gemini-bundle --title "gemini Test Bundle" --force`
   `python3 scripts/agentpress.py verify /tmp/gemini-bundle --json`
