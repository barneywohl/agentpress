# AgentPress Quickstart for browser
...
3. Generate/verify a bundle:
   `python3 scripts/agentpress.py bundle tests/fixtures/source-docs --out /tmp/browser-bundle --title "browser Test Bundle" --force`
   `python3 scripts/agentpress.py verify /tmp/browser-bundle --json`
